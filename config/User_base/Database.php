...
class Database {
    ...
    // Constructeur prive = empêche new Database()
...
// executer le contenu des fichiers ddl.sql et dml.sql.
    ...
    public static function migrate_and_seed() {
        ...
        $table= file_get_contents(__DIR__ . "/../../database/ddl.sql");
        $insertion= file_get_contents(__DIR__ ."/../../database/dml.sql");
