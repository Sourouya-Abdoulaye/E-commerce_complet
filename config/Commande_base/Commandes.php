...
class Commandes {
    ...
    private function __construct()  {
        ...
        $dbPath = __DIR__ . '/../../commandes/Commandes.db';
...
// executer le contenu des fichiers ddl.sql et dml.sql.
    ...
    public static function migrate_and_seed() {
        ...
        $table= file_get_contents(__DIR__ . "/../../commandes/ddl.sql");
        $insertion= file_get_contents(__DIR__ ."/../../commandes/dml.sql");
